---
layout: post
title: "TCS ILP Trivandrum Accommodation"
date: 2018-02-19
categories: ["Industry"]
tags: ["ILP", "TCS"]
...
![TCS ILP Trivandrum Accommodation - Insight Crunch](/assets/images/blog/blog-106.webp)
...
If you are still going through the TCS recruitment process, the [TCS NQT Preparation Guide on ReportMedic](https://reportmedic.org/tools/tcs-nqt-preparation-guide.html) is a thorough resource for cracking the assessment. And once you have cleared recruitment and are preparing for the ILP itself, the [TCS ILP Preparation Guide on ReportMedic](https://reportmedic.org/tools/tcs-ilp-preparation-guide.html) will help you hit the ground running from Day 1.

I have given details for both male associates and female associates. During this period the TCS Trivandrum campus was full of trainees, and there were accommodations at different places provided by TCS, each with a different character, location, and set of trade-offs. This guide covers all of them honestly, so you know what to expect rather than what TCS's administrative correspondence suggests.
...
1. Identify your nearest campus canteen options and their menus during the first week.
2. Set up accounts on Swiggy and Zomato before you arrive and confirm they cover your accommodation area.
3. Identify the two or three delivery restaurants within your delivery radius that will become your reliable rotation for different meal types.
4. Establish relationships with at least one nearby dhaba or restaurant for in-person meals, especially on weekends when you want a sit-down meal without the hassle of delivery logistics.
5. For those staying near Kazhakootam or in locations with better local access, identify the Arya's restaurant, Delhi Darbar, and Sharma Dhaba early as reliable options.
