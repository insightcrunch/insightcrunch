---
layout: post
title: "SAT Data in Reading Passages: Charts, Tables, and Graphs Strategy"
page_title: "SAT Data Interpretation in Reading Passages: How to Read Charts, Tables, and Graphs Integrated Into Reading and Writing Questions on the Digital SAT"
date: 2020-02-17
categories: ["Industry"]
...
![SAT Data in Reading Passages: Charts, Tables, and Graphs Strategy](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
1. [What Data-Integrated Passages Look Like](#what-data-integrated-passages-look-like)
2. [The Five Display Types](#the-five-display-types)
3. [The Universal Display-Reading Protocol](#the-universal-display-reading-protocol)
4. [Bar Graphs: Reading Strategy and Common Errors](#bar-graphs-reading-strategy-and-common-errors)
5. [Line Graphs: Reading Strategy and Common Errors](#line-graphs-reading-strategy-and-common-errors)
6. [Scatter Plots: Reading Strategy and Common Errors](#scatter-plots-reading-strategy-and-common-errors)
7. [Tables: Reading Strategy and Common Errors](#tables-reading-strategy-and-common-errors)
8. [Pie Charts: Reading Strategy and Common Errors](#pie-charts-reading-strategy-and-common-errors)
9. [The Four Data Question Types](#the-four-data-question-types)
10. [Connecting Data to Text: The Core Skill](#connecting-data-to-text-the-core-skill)
11. [When Data Partially Supports and Partially Contradicts](#when-data-partially-supports-and-partially-contradicts)
12. [Common Traps in Data Questions](#common-traps-in-data-questions)
13. [Practice Approaches for Building Speed and Accuracy](#practice-approaches-for-building-speed-and-accuracy)
14. [Data Questions Within Information and Ideas](#data-questions-within-information-and-ideas)
...
**Row totals:** Show total observations for that row across all column categories.
**Column totals:** Show total observations for that column across all row categories.
**Grand total:** Shows all observations, usually in the bottom-right cell.
...
Step 1: Verify the units - the sentence says "%" so the answer must be a percentage.
Step 2: Find the 18-34 row in the table.
Step 3: Find the "daily usage" column.
Step 4: Read the intersection: 78.
...
For additional context on how data questions fit within the broader evidence and information question framework, the guide on [SAT reading passage types and evidence-based questions](https://insightcrunch.com/2020/03/04/sat-reading-passage-types-evidence-questions-guide/) covers the analytical skills for evaluating claims and evidence that transfer directly to data question work.
...
### How do I handle a data display with multiple competing trends?
...
For additional preparation on the evidence evaluation skills that underpin data questions, the companion guide on [SAT transitions and logical flow](https://insightcrunch.com/2020/02/25/sat-transitions-logical-flow-questions-guide/) covers the logical relationship skills that transfer directly to evaluating whether data supports, undermines, or merely relates to a text claim.
