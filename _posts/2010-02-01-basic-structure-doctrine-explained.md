---
layout: post
title: "Kesavananda and the Basic Structure Doctrine"
page_title: "The Basic Structure Doctrine Explained: What Kesavananda Bharati Actually Decided, the Cases That Built the Test, and Why the List of Basic Features Was Never Closed"
date: 2010-02-01
categories: ["Industry"]
...
Readers who want to see how the same government's constitutional project developed after this point should read this series' treatment of [the 42nd Amendment and what it attempted to entrench](/2010/02/15/42nd-amendment-act-1976-explained/), which contains the most aggressive attempt ever made to abolish the limitation Kesavananda had created.
...
The first is procedural and textual. An amendment must be introduced correctly, must obtain the special majority in each House, and where it affects the specified federal provisions it must additionally be ratified by the legislatures of at least half the states. An amendment that misses any of these fails, and it fails without any court needing to consider its substance. That has happened, and the mechanics of it are set out in this series' guide to [the amendment procedure and the ratification proviso](/2010/01/01/constitution-amendment-process-india/).
