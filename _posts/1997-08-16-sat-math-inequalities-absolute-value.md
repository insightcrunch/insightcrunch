---
layout: post
title: "SAT Math: Inequalities and Absolute Value"
page_title: "SAT Inequalities and Absolute Value: Sign Flips, AND vs OR, and Systems Shading Explained"
date: 1997-08-16
categories: ["Industry"]
...
![SAT inequalities and absolute value sign flip AND vs OR systems shading worked examples - Insight Crunch](/assets/images/blog/blog-101.webp)
...
The principle: the extreme value of a linear expression over a feasible polygon always occurs at a corner, so you find the corners by intersecting the boundary lines, evaluate the expression at each, and pick the largest or smallest; you never need to check interior points. The [systems of equations guide on solution counts](/1997/07/29/sat-math-systems-no-infinite-solutions/) treats the equality version of multi-line problems, and the relational version is the natural next step, swapping single intersection points for whole regions.
