---
layout: post
title: "How to Get Into Harvard - Complete Application Guide"
page_title: "How to Get Into Harvard University: The Complete Application Guide for Undergraduate and Graduate Applicants"
date: 2019-01-31
categories: ["Industry"]
...
![How to Get Into Harvard - Complete Application Guide](/assets/images/blog/blog-12.webp)
...
For the financial side of attending Harvard after admission - including the remarkable financial aid programme that makes Harvard genuinely affordable for many families - the [Harvard Student Budget guide](https://insightcrunch.com/2019/02/08/harvard-student-budget-real-cost/) and the [Harvard Accommodation Costs Breakdown](https://insightcrunch.com/2019/04/05/harvard-accommodation-costs-breakdown/) provide the complete financial picture.

---

## Table of Contents

1. [Understanding Harvard's Admissions Philosophy](#understanding-harvards-admissions-philosophy)
2. [The Harvard Application Timeline](#the-harvard-application-timeline)
3. [Restrictive Early Action vs Regular Decision](#restrictive-early-action-vs-regular-decision)
4. [Academic Requirements: What Harvard Expects](#academic-requirements-what-harvard-expects)
5. [Standardised Tests: SAT, ACT, and Harvard's Policy](#standardised-tests-sat-act-and-harvards-policy)
6. [The Common Application and Harvard's Supplemental Essays](#the-common-application-and-harvards-supplemental-essays)
7. [Writing the Harvard Essays: What Works](#writing-the-harvard-essays-what-works)
8. [Letters of Recommendation](#letters-of-recommendation)
9. [Extracurricular Activities: What Harvard Values](#extracurricular-activities-what-harvard-values)
10. [The Harvard Interview](#the-harvard-interview)
11. [How the Admissions Decision Is Made](#how-the-admissions-decision-is-made)
12. [The Harvard Waitlist](#the-harvard-waitlist)
13. [Contextual and Demographic Factors](#contextual-and-demographic-factors)
14. [Applying to Harvard as an International Student](#applying-to-harvard-as-an-international-student)
15. [Harvard Graduate Admissions](#harvard-graduate-admissions)
16. [Harvard Business School Admissions](#harvard-business-school-admissions)
17. [Harvard Law School Admissions](#harvard-law-school-admissions)
18. [Harvard Medical School Admissions](#harvard-medical-school-admissions)
19. [What To Do If You Are Not Admitted](#what-to-do-if-you-are-not-admitted)
...
The ReportMedic [CAT PYQ Explorer](https://reportmedic.org/tools/cat-previous-year-question-papers.html) provides analytical reasoning practice that builds the quantitative and verbal skills tested in Harvard's admissions processes for international applicants from competitive examination backgrounds.
...
There is no minimum GPA requirement. The middle 50% of admitted students have unweighted GPAs of approximately 3.9-4.0. Students with lower GPAs have been admitted in contexts where the lower GPA reflects specific circumstances or where other dimensions of the application are particularly compelling. Course rigor matters alongside GPA.

**What is Harvard's acceptance rate?**
Harvard's undergraduate acceptance rate is approximately 3-4% in recent admissions cycles, making it the most selective university in the United States. The REA acceptance rate is typically slightly higher, primarily reflecting the stronger average profile of early applicants.

**Does Harvard prefer Restrictive Early Action applicants?**
Harvard does not have a stated preference for early applicants, but the REA pool has a slightly higher acceptance rate historically. This is primarily because early applicants tend to have stronger overall profiles on average, not because applying early confers an inherent advantage.

**Do extracurriculars matter more than grades at Harvard?**
Neither is more important than the other - both are important parts of a holistic evaluation. Academic excellence is a baseline requirement; extracurricular engagement and character are differentiators within the academically qualified pool. Both matter significantly.

**How important is the Harvard interview?**
The interview is one data point among many in the holistic evaluation. It is an opportunity to add dimension to the application and to demonstrate the kind of intellectual engagement that Harvard values. It is not a make-or-break element for most applicants, but performing poorly can hurt while performing well rarely provides decisive advantage.

**Can I get into Harvard without perfect SAT/ACT scores?**
...
**Does Harvard prefer certain high schools or courses?**
Harvard does not formally prefer students from specific schools. What matters is what the student has done with the opportunities available to them. A student who has achieved the top of their class at an under-resourced public school is presenting a different and often more compelling academic profile than a student from a prestigious private school who ranks in the middle of their class.

**How many recommendation letters does Harvard require?**
Harvard requires one school counsellor recommendation, two teacher recommendations, and allows one optional additional recommender. More than the required number is not advantageous.

**Is it harder to get into Harvard from certain states?**
The effective competition rate varies by geography. Students from states with fewer Harvard applicants face less within-geographic-pool competition. Students from high-application states (Massachusetts, New York, California) face more competition within their geographic pool.

**How does Harvard's financial aid affect admission decisions?**
Harvard is need-blind in admissions for domestic and international undergraduates - financial circumstances do not affect admissions decisions. The financial aid award is determined entirely separately from the admissions decision.

**What is the best essay topic for Harvard?**
There is no single best topic. The best Harvard essay is one that reveals genuine intellectual engagement, specific personal insight, and authentic voice - regardless of the subject matter. Essays about seemingly ordinary topics that reveal extraordinary insight are often more effective than essays about seemingly extraordinary topics that reveal ordinary thinking.

**Does Harvard have a preference for legacy applicants?**
Harvard has historically given legacy applicants (children of Harvard alumni) some admissions preference. The specific current policy and its application have been subject to change and legal scrutiny. Applicants should check Harvard's current official policy rather than relying on historical information.

**How important is demonstrated interest to Harvard?**
Harvard does not formally track demonstrated interest (campus visits, interviews with admissions officers) in its admissions process. Visiting campus, if possible, is valuable for the applicant's own information-gathering rather than as a signal to Harvard.
...
**How does applying to Harvard work for non-traditional students?**
...
The [Harvard Accommodation Complete Guide](https://insightcrunch.com/2019/04/21/harvard-accommodation-complete-guide/) and the [Harvard Student Budget guide](https://insightcrunch.com/2019/02/08/harvard-student-budget-real-cost/) provide the practical information for students who receive a Harvard offer and want to understand what comes next. The [Harvard Student Life guide](https://insightcrunch.com/2019/01/23/harvard-student-life-what-nobody-tells-you/) covers what Harvard is actually like once you arrive. The ReportMedic [CAT PYQ Explorer](https://reportmedic.org/tools/cat-previous-year-question-papers.html) builds the analytical reasoning skills that Harvard's admissions processes reward across all programme types.
...
The financial aid resources for accepted students are described in the [Harvard Student Budget guide](https://insightcrunch.com/2019/02/08/harvard-student-budget-real-cost/), which provides the detailed picture of what Harvard actually costs for students at different income levels.
...
Beginning to think about housing and orientation logistics. The [Harvard Accommodation Complete Guide](https://insightcrunch.com/2019/04/21/harvard-accommodation-complete-guide/) provides comprehensive housing information.
...
The ReportMedic [CAT PYQ Explorer](https://reportmedic.org/tools/cat-previous-year-question-papers.html) provides rigorous analytical reasoning practice. The [Harvard Student Life guide](https://insightcrunch.com/2019/01/23/harvard-student-life-what-nobody-tells-you/) describes what Harvard is actually like once you are there - useful context for anyone deciding whether Harvard is genuinely right for them. The [Harvard Accommodation Complete Guide](https://insightcrunch.com/2019/04/21/harvard-accommodation-complete-guide/) and the [Harvard Neighborhoods Guide](https://insightcrunch.com/2019/03/04/harvard-neighborhoods-guide-students/) cover the practical aspects of life in Cambridge.
