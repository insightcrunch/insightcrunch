...
tags: []
excerpt: "Excel Pivot Tables can't count distinct values natively. Here is the data model trick that gives you accurate distinct counts without VBA or formulas."
