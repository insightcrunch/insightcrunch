---
title: "Flashback and Chronology in The Great Gatsby"
...
This embedded recollection also models how the whole novel handles its deepest material: at a remove, through a teller, partial and angled. The technique connects directly to the way the entire book is framed as Nick's later reconstruction, an architecture examined in the study of [the frame narrative and retrospection in Gatsby](/2026/02/02/gatsby-frame-narrative/). Jordan's flashback is a frame inside a frame, a memory nested within Nick's larger memory, and the nesting is part of the design. For the scene-level reading of how this chapter stages its disclosure, the [close reading of Chapter 4 and Jordan's flashback](/2022/09/12/great-gatsby-chapter-4-jordan-flashback/) follows the passage beat by beat.
