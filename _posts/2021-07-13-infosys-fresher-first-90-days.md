---
layout: post
title: "Infosys Fresher Experience: First 90 Days on a Project"
page_title: "Infosys Fresher Experience: What the First 90 Days on a Project Actually Look Like After Mysore Training"
date: 2021-07-13
categories: ["Industry"]
...
![Infosys Fresher First 90 Days on Project](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
1. [The Transition From Mysore to Project: What Changes](#the-transition-from-mysore-to-project-what-changes)
2. [The Project Allocation Process](#the-project-allocation-process)
3. [Week 1: Orientation and the Onboarding Fog](#week-1-orientation-and-the-onboarding-fog)
4. [Understanding Your Project: Codebase, Architecture, and Context](#understanding-your-project-codebase-architecture-and-context)
5. [Your First Task: What to Expect and How to Handle It](#your-first-task-what-to-expect-and-how-to-handle-it)
6. [Working With Your Team Lead and Manager](#working-with-your-team-lead-and-manager)
7. [Client Communication: What It Looks Like as a Fresher](#client-communication-what-it-looks-like-as-a-fresher)
8. [Agile and Project Management: How Work Is Organized](#agile-and-project-management-how-work-is-organized)
9. [Common Mistakes Freshers Make in the First 90 Days](#common-mistakes-freshers-make-in-the-first-90-days)
10. [What Strong First-Year Performance Actually Looks Like](#what-strong-first-year-performance-actually-looks-like)
11. [Managing Remote Work and Hybrid Arrangements](#managing-remote-work-and-hybrid-arrangements)
12. [The First Appraisal: What It Evaluates and How to Prepare](#the-first-appraisal-what-it-evaluates-and-how-to-prepare)
13. [Building Relationships That Matter in the First 90 Days](#building-relationships-that-matter-in-the-first-90-days)
14. [Technical Growth During the First Project](#technical-growth-during-the-first-project)
...
Do not silently absorb the expanded scope and delay your committed delivery without communicating.
Communicate the discovery to the team lead immediately: "The bug fix also revealed two related issues in the same component. Should I fix all three in this ticket or create separate tickets for the other two?"
...
The first formal [performance appraisal at Infosys](https://insightcrunch.com/2021/06/27/infosys-performance-appraisal/) typically happens at the six-month mark (mid-year review) and the twelve-month mark (annual review). Understanding what it evaluates and how it is conducted prevents the surprise that many freshers experience when they receive lower ratings than they expected.
...
Learning and development: certifications completed, new skills developed, and engagement with Infosys's learning platforms (Lex, [InfyTQ](https://insightcrunch.com/2021/10/09/infytq-preparation-guide/)).
...
## Navigating the Office Culture and Dress Code
...
Tasks completed: list every task you completed with the sprint it was in and the outcome.
Code contributions: list PRs merged, bugs fixed, features delivered.
Certifications or training completed.
Skills developed: new technologies or concepts you understand now that you did not when you started.
Challenges and how you addressed them.

**Questions to Ask in the 90-Day Conversation:**

"What are the two or three things I should focus on improving most in the next quarter?"
"Are there specific skills or knowledge areas that would make me more effective on this project?"
"Is there a more challenging task area I can take on in the next sprint?"
...
Looking at the profile of Infosys engineers who transition to product companies or GCCs with strong outcomes, who progress quickly through the [Infosys designation hierarchy](https://insightcrunch.com/2021/12/12/infosys-career-growth/), or who build meaningful technical expertise within IT services, the common factors are not surprising but they are specific:
