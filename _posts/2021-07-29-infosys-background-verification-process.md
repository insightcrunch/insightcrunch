---
layout: post
title: "Infosys Background Verification Process: Complete Guide"
page_title: "Infosys Background Verification Process Explained: What Gets Checked, How Long It Takes, What Flags Mean, and How to Navigate It Successfully"
date: 2021-07-29
categories: ["Industry"]
tags: ["Infosys Background Verification", "Infosys BGV Process", "Infosys Background Check", "Infosys BGV Status", "Infosys Offer Withdrawal", "Infosys BGV Discrepancy", "Infosys Joining Documents", "Infosys Verification Process"]
excerpt: "Complete guide to the Infosys background verification process covering what gets checked, timelines, what triggers flags, how to resolve discrepancies, and what happens when BGV finds an issue."
...
![Infosys Background Verification Process](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
1. [What the Infosys BGV Process Is and Why It Exists](#what-the-infosys-bgv-process-is-and-why-it-exists)
2. [Who Conducts the BGV: Third-Party Agencies](#who-conducts-the-bgv-third-party-agencies)
3. [The Six Components of Infosys BGV](#the-six-components-of-infosys-bgv)
4. [Education Verification: How It Works](#education-verification-how-it-works)
5. [Employment Verification: How It Works](#employment-verification-how-it-works)
6. [Identity Verification: How It Works](#identity-verification-how-it-works)
7. [Address Verification: How It Works](#address-verification-how-it-works)
8. [Criminal Record Check: How It Works](#criminal-record-check-how-it-works)
9. [Reference Check: How It Works](#reference-check-how-it-works)
10. [BGV Timeline: What to Realistically Expect](#bgv-timeline-what-to-realistically-expect)
11. [BGV Statuses Explained](#bgv-statuses-explained)
12. [What Triggers a BGV Flag](#what-triggers-a-bgv-flag)
13. [How BGV Discrepancies Are Resolved](#how-bgv-discrepancies-are-resolved)
14. [When BGV Results in Serious Consequences](#when-bgv-results-in-serious-consequences)
15. [Proactive Steps to Support Your BGV](#proactive-steps-to-support-your-bgv)
16. [BGV for Different Hiring Tracks](#bgv-for-different-hiring-tracks)
17. [BGV After Joining: Can It Still Affect You?](#bgv-after-joining-can-it-still-affect-you)
...
List every academic institution you attended. For each, note the official name (not a nickname), the board or university affiliation, and the contact information for the registrar or examination cell.

**Day 2-3:**
Gather every academic document physically: 10th, 12th, all undergraduate semester mark sheets, degree or provisional certificate. Photograph each document in good lighting on a white background. Organize into a digital folder named "BGV Documents" in cloud storage.

**Day 4:**
Calculate your aggregate percentage using the official university methodology. If you are not certain of the official methodology, call the examination cell now. Write down the calculation clearly so you can explain it if needed.

**Day 5:**
Check each document for name consistency and date of birth consistency. Note any discrepancies. If discrepancies exist, begin drafting a self-declaration explaining them.

**Day 6-7:**
Complete the [iConnect portal](https://insightcrunch.com/2021/08/06/infosys-offer-letter-iconect-joining/) academic section using the official figures computed from your actual documents. Double-check every entry against the physical document before moving to the next entry.

**Day 8 onward:**
Upload documents one by one, verifying each upload is successful and the uploaded version is legible before moving to the next. Check the portal two to three times per week for status updates or queries. Respond to any query within 24 hours of receiving it.
...
**[InfyTQ](https://insightcrunch.com/2021/10/09/infytq-preparation-guide/) and Off-Campus (SE Track):**
