...
excerpt: "Oracle DRM: map one physical hierarchy to multiple logical views. How to provide different perspectives of the same data for different business needs."
