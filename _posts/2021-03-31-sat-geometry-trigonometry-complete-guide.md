---
layout: post
title: "SAT Geometry and Trigonometry: Every Topic Explained"
page_title: "SAT Geometry and Trigonometry Complete Guide: Angles, Triangles, Circles, Coordinate Geometry, and Trig Ratios for the Digital SAT"
date: 2021-03-31
categories: ["Industry"]
...
![SAT Geometry and Trigonometry Complete Guide](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
- [Why This Domain Demands Dedicated Preparation](#why-this-domain-demands-dedicated-preparation)
- [The SAT Reference Sheet: What Is Provided and What You Must Memorize](#the-sat-reference-sheet-what-is-provided-and-what-you-must-memorize)
...
- [Special Right Triangles: 45-45-90](#special-right-triangles-45-45-90)
- [Special Right Triangles: 30-60-90](#special-right-triangles-30-60-90)
...
- [Circles](#circles)
- [Circumference and Area](#circumference-and-area)
- [Arc Length and Sector Area](#arc-length-and-sector-area)
- [Central Angles and Inscribed Angles](#central-angles-and-inscribed-angles)
- [Tangent Lines](#tangent-lines)
- [Circle Equations in the Coordinate Plane](#circle-equations-in-the-coordinate-plane)
- [Completing the Square for Circle Equations](#completing-the-square-for-circle-equations)
- [Polygons: Area and Perimeter](#polygons-area-and-perimeter)
...
- [Volume and Surface Area of 3D Solids](#volume-and-surface-area-of-3d-solids)
- [Rectangular Prisms (Boxes)](#rectangular-prisms-boxes)
- [Cylinders](#cylinders)
- [Cones](#cones)
- [Spheres](#spheres)
- [Pyramids](#pyramids)
- [Composite Solids and Dimensional Changes](#composite-solids-and-dimensional-changes)
- [Coordinate Geometry](#coordinate-geometry)
- [The Distance Formula](#the-distance-formula)
- [The Midpoint Formula](#the-midpoint-formula)
- [Slope and Line Equations in Coordinate Geometry](#slope-and-line-equations-in-coordinate-geometry)
- [Parallel and Perpendicular Lines in the Coordinate Plane](#parallel-and-perpendicular-lines-in-the-coordinate-plane)
- [Trigonometry](#trigonometry)
- [SOH-CAH-TOA: The Basic Ratios](#soh-cah-toa-the-basic-ratios)
- [The Complementary Angle Relationship](#the-complementary-angle-relationship)
- [Radians and Degree Conversion](#radians-and-degree-conversion)
- [Unit Circle Basics](#unit-circle-basics)
- [Applying Trigonometry to Real-World Problems](#applying-trigonometry-to-real-world-problems)
- [Shaded Region Problems](#shaded-region-problems)
- [Multi-Step Geometry Strategy](#multi-step-geometry-strategy)
- [Desmos Strategies for Geometry](#desmos-strategies-for-geometry)
- [Common Traps in Geometry and Trigonometry](#common-traps-in-geometry-and-trigonometry)
- [Score-Level Strategies](#score-level-strategies)
...
Special right triangle ratios: 45-45-90 (x, x, x*sqrt(2)) and 30-60-90 (x, x*sqrt(3), 2x)
...
Arc length: L = (theta/360) * 2*pi*r (degrees) or L = r*theta (radians)
...
Area = (1/2)(10)(5*sqrt(3)) = 25*sqrt(3) ≈ 43.30
...
Side = 10/sqrt(2) = 10*sqrt(2)/2 = 5*sqrt(2) ≈ 7.071
...
The medium leg = x*sqrt(3) = 9, so x = 9/sqrt(3) = 9*sqrt(3)/3 = 3*sqrt(3)

The short leg = 3*sqrt(3) ≈ 5.196

The hypotenuse = 2 * 3*sqrt(3) = 6*sqrt(3) ≈ 10.392
...
Arc length = (theta/360) * 2*pi*r, where theta is the central angle in degrees.
...
Arc length = (72/360) * 2*pi*10 = (1/5) * 20*pi = 4*pi ≈ 12.566

Sector area = (72/360) * pi*100 = (1/5) * 100*pi = 20*pi ≈ 62.832
...
Arc length = (120/360) * 2*pi*8 = (1/3) * 16*pi = 16*pi/3 ≈ 16.755 inches.
...
Sector area = (150/360) * pi * 15^2 = (5/12) * 225*pi = (1125/12)*pi = 93.75*pi ≈ 294.52 square feet.
...
5*pi = (theta/360) * 2*pi*10

5*pi = (theta/360) * 20*pi
...
The arc is a quarter of the circle, which makes sense: 5*pi is one-quarter of the full circumference 20*pi.
...
Lateral surface area: LSA = 2*pi*r*h

Total surface area: SA = 2*pi*r*h + 2*pi*r^2 (lateral plus two circular bases)
...
200*pi = pi * r^2 * 8. Divide by 8*pi: r^2 = 25, so r = 5.
...
A cone has radius 6 and height 10. Volume = (1/3)*pi*36*10 = 120*pi ≈ 376.991.
...
A sphere has radius 3. Volume = (4/3)*pi*27 = 36*pi ≈ 113.097.

**Worked Example (Finding Radius From Volume):**

A sphere has volume 288*pi. Find the radius.

288*pi = (4/3)*pi*r^3. Divide by pi: 288 = (4/3)*r^3. Multiply by 3/4: r^3 = 216. r = 6.
...
Hemisphere volume: (1/2)(4/3)*pi*1000 = (2/3)*1000*pi = (2000/3)*pi

Total: 3000*pi + (2000/3)*pi = (9000/3 + 2000/3)*pi = (11000/3)*pi ≈ 11,519.17
...
Original: V = pi*r^2*h. New: V = pi*(2r)^2*h = pi*4r^2*h = 4 * original volume.
...
Doubling a radius: area multiplied by 4, volume multiplied by 8.
Tripling a side length: area multiplied by 9, volume multiplied by 27.
Halving a dimension: area multiplied by 1/4, volume multiplied by 1/8.
...
Ratio: 360*pi / 160*pi = 360/160 = 9/4 = 2.25
...
On the SAT, this type of question usually uses cleaner numbers. For instance, if the volume were (2/3)*pi*216 = 144*pi, then r^3 = 216, r = 6, and h = 12.
...
Cone: (1/3)*pi(25)(12) = 100*pi

Fraction: 100*pi / 300*pi = 1/3
...
Percentage filled: (960*pi / 1280*pi) * 100 = (960/1280) * 100 = 75%
...
Ratio: (4/3)*pi*r^3 / (2*pi*r^3) = (4/3)/2 = 2/3
...
If the answer choices are in simplified radical form, you need to simplify: sqrt(52) = sqrt(4*13) = 2*sqrt(13).
...
Perimeter = 8 + 2*sqrt(13) + 2*sqrt(13) = 8 + 4*sqrt(13) ≈ 22.42
...
If you know the hypotenuse and need the opposite side: use sin.
If you know the hypotenuse and need the adjacent side: use cos.
If you know one leg and need the other leg: use tan.
If you know the opposite side and need the hypotenuse: use sin (rearranged).
If you know the adjacent side and need the hypotenuse: use cos (rearranged).
...
150 * (pi/180) = 150*pi/180 = 5*pi/6 radians.
...
Circle area: pi*5^2 = 25*pi ≈ 78.54
...
Circle area: pi*64 = 64*pi ≈ 201.06
...
Each semicircle has radius 4 and area (1/2)*pi*16 = 8*pi. Two semicircles: 16*pi.
...
This is a classic problem. Each quarter-circle covers one-fourth of a circle with radius 10. The area of each quarter-circle is (1/4)*pi*100 = 25*pi.

The region covered by two overlapping quarter-circles from adjacent corners has area = (area of two quarter-circles) - (area of square) = 2(25*pi) - 100 = 50*pi - 100.
...
Each semicircle has area (1/2)*pi*16 = 8*pi.
...
Ring area = (area of outer circle) - (area of inner circle) = pi*100 - pi*36 = 64*pi ≈ 201.06
...
Approximately 5 to 7 of the 44 total Math questions, making it the smallest domain by question count.

**What geometry formulas are provided on the SAT reference sheet?**
Area of circles, rectangles, and triangles; the Pythagorean theorem; special right triangle ratios; and volumes of rectangular prisms, cylinders, spheres, cones, and pyramids.

**What formulas do I need to memorize?**
The distance formula, midpoint formula, circle equation in standard form, arc length, sector area, area of a trapezoid, trig ratios (SOH-CAH-TOA), and the complementary angle relationship.

**How do I complete the square for a circle equation?**
Group x and y terms, take half of each linear coefficient and square it, add those values to both sides, then factor each group into a perfect square. The result is standard form: (x-h)^2 + (y-k)^2 = r^2.

**What are the most common Pythagorean triples?**
3-4-5, 5-12-13, 8-15-17, and 7-24-25, plus their multiples (6-8-10, 9-12-15, 10-24-26, etc.).

**What is the relationship between an inscribed angle and a central angle?**
An inscribed angle is exactly half of the central angle that subtends the same arc. Conversely, the central angle is twice the inscribed angle.

**How do special right triangles appear on the SAT?**
They appear in problems involving square diagonals (45-45-90), equilateral triangle heights (30-60-90), and any right triangle where the angles are 30, 45, or 60 degrees.

**What trigonometry is tested on the SAT?**
Basic trig ratios (SOH-CAH-TOA), the complementary angle relationship (sin(x) = cos(90-x)), radian-degree conversion, and basic unit circle coordinates for standard angles.

**Do I need to memorize the unit circle?**
You need to know the sine and cosine values for 0, 30, 45, 60, and 90 degrees. You do not need to memorize the full unit circle beyond these standard angles.

**How do I handle shaded region problems?**
Calculate the area of the larger shape and subtract the area of the removed shape(s). Draw and label all components before calculating.

**What is the most commonly tested geometry topic?**
Circle equations (completing the square to find center and radius) and right triangle problems (Pythagorean theorem and special right triangles) appear most frequently.

**How does doubling the radius affect volume?**
Doubling the radius multiplies the volume by 2^3 = 8 for spheres, and by 2^2 = 4 for cylinders and cones (since the radius appears squared in their formulas and the height stays the same).

**When should I use trigonometry instead of the Pythagorean theorem?**
Use the Pythagorean theorem when you know two sides of a right triangle and need the third. Use trig ratios when you know one side and one acute angle and need another side.

**How do I identify similar triangles?**
Two triangles are similar if they share two pairs of equal angles (AA similarity), if all three pairs of corresponding sides are proportional (SSS similarity), or if two pairs of sides are proportional with the included angle equal (SAS similarity).

**What is the fastest approach for coordinate geometry questions?**
Identify what you need (distance, midpoint, slope, equation), apply the appropriate formula directly, and verify if time allows. For circle equations, complete the square mechanically without hesitation.

**Can I use Desmos for geometry questions?**
Yes. Desmos is useful for graphing circles, finding intersections, evaluating trig functions, and verifying coordinate calculations. However, it cannot draw or measure arbitrary geometric figures.

**How do I handle problems where no figure is provided?**
Draw your own figure based on the given information. Label all known measurements. This visual representation often makes the solution path much clearer than working purely from the text.

**What is the perpendicular bisector and how does the SAT test it?**
The perpendicular bisector of a segment passes through the midpoint and is perpendicular to the segment. To find it, compute the midpoint, find the negative reciprocal of the segment's slope, and write the line equation through the midpoint with that slope.

**How important is this domain for my overall score?**
With 5 to 7 questions, it contributes approximately 50 to 70 points. These points are highly learnable, and the topics overlap with coordinate geometry in Algebra and completing the square in Advanced Math, so mastery has cross-domain benefits.
