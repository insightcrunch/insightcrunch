---
layout: post
title: "SAT Ratios, Percentages, and Proportions: Complete Guide"
page_title: "SAT Ratios, Percentages, and Proportions Complete Guide: Unit Rates, Percent Change, Proportional Relationships, and Every Calculation Tested on the Digital SAT"
date: 2020-03-28
categories: ["Industry"]
...
![SAT Ratios, Percentages, and Proportions Complete Guide](/assets/images/blog/blog-32.webp)
...
1. [Ratio Concepts: Part-to-Part and Part-to-Whole](#ratio-concepts)
2. [Setting Up and Solving Proportions](#setting-up-and-solving-proportions)
3. [Unit Rates and Rate Conversions](#unit-rates-and-rate-conversions)
4. [Speed, Distance, and Time Problems](#speed-distance-and-time-problems)
5. [Percentage Calculations: All Three Types](#percentage-calculations-all-three-types)
6. [Percent Increase and Percent Decrease](#percent-increase-and-percent-decrease)
7. [Successive Percentage Changes](#successive-percentage-changes)
8. [Real-World Percentage Word Problems](#real-world-percentage-word-problems)
9. [Unit Conversions](#unit-conversions)
10. [Density and Concentration Problems](#density-and-concentration-problems)
11. [Scaling Problems](#scaling-problems)
12. [Mixture Problems](#mixture-problems)
13. [When to Use Desmos vs. Mental Math](#when-to-use-desmos-vs-mental-math)
...
Step 1: Identify whether the ratio given is part-to-part or part-to-whole.
Step 2: Write the quantities using the ratio multiplier (2k, 3k, etc.).
Step 3: Use any additional information to find k.
Step 4: Answer the specific question asked (a part, the total, a different ratio, etc.).
...
Step 1: Identify the two ratios that should be equal.
Step 2: Set them up as a proportion with consistent units in numerator and denominator positions.
Step 3: Cross-multiply and solve.
Step 4: Check: does the answer make logical sense in context?

### For Percentage Questions

Step 1: Identify which of the three types this is (find part, find whole, find percentage).
Step 2: Use the formula Part = Percent times Whole, solving for whatever is unknown.
Step 3: For percent change, always use the formula (New - Original)/Original and use the ORIGINAL as the denominator.
Step 4: Verify: a percentage must be between 0% and some reasonable upper bound given the context.

### For Mixture and Concentration Questions

Step 1: Identify what is being combined (solutions, products, populations) and what property is being tracked (concentration, price, rate).
Step 2: Write two equations: total amount and total property (amount times concentration summed for each component).
Step 3: Solve the system.
Step 4: Verify by checking that the combined concentration or value is between the two component values.
...
Use this guide as the foundation of your ratio and percentage preparation. Practice each technique with official College Board questions until the setup becomes automatic. Build speed through deliberate practice that emphasizes recognizing the problem type before writing anything. And approach test day with the confidence that proportional reasoning, fully developed, is one of the most versatile and reliable mathematical tools available for the SAT Math section. Every question in this topic area is answerable through the methods this guide has presented. The preparation is complete; the application is yours.
 That combination of foundational understanding and practiced fluency is the complete answer to how to perform reliably and efficiently on every ratio, percentage, and proportion question the SAT presents. Begin with the first example in this guide, build through every section, verify mastery through official practice, and arrive at test day prepared to convert every proportional reasoning question into a reliable source of points.
 The work invested in mastering this topic area is work that pays dividends on test day and far beyond it, because proportional reasoning is one of the most broadly applicable quantitative skills in academic and professional life. Master it thoroughly through the preparation this guide has outlined, and the benefits will extend well past the SAT.
