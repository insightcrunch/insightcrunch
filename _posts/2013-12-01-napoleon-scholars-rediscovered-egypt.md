---
layout: post
title: "Napoleon's Scholars: The Army That Launched Egyptology"
page_title: "How Napoleon's Scholars Revealed Egypt: The Commission of Sciences and Arts, the Institut d'Egypte, the Survey of the Monuments, and the Making of the Description de l'Egypte"
date: 2013-12-01
categories: ["Leisure"]
...
The first and most consequential body of work came out of the military pursuit that followed the destruction of Mamluk power at Embabeh, described in the article on [the battle of the pyramids](/2013/11/01/battle-of-the-pyramids/).
...
At Thebes the teams worked across the whole site: the temple complex at Karnak, whose scale had never been properly conveyed to a European audience and which is treated in the article on [the temple of Karnak at Thebes](/2003/09/01/temple-of-karnak-at-thebes/); the Luxor temple; the mortuary temples on the west bank; the colossi on the plain; and the royal tombs cut into the rock in the valley behind, the subject of the article on [the Valley of the Kings](/2004/01/01/valley-of-the-kings-explained/). Jollois and Villiers du Terrage, the two young polytechnic engineers, did an extraordinary amount of this work.
...
Pierre-Simon Girard led the hydrological program, studying the Nile's behavior, the mechanics of the flood, the condition of the canal network, and the basin irrigation system on which Egyptian agriculture depended. His reports describe a system badly degraded by the tax-farming regime, a diagnosis consistent with what is set out in the article on [how Egypt was governed by the Ottomans](/2013/07/01/egypt-under-ottoman-rule/), and they propose remedies. The observations of Nile levels, canal capacities, and basin layouts are the earliest systematic hydrological data on Egypt.
...
For turning that into revision material, you can [save this guide and build your own Egypt timeline free on VaultBook](https://vaultbook.net/tools/egypt-history-notes.html), keep the components table where you can reorder it, and set the commission's dates against the military campaign so the relationship between the failed occupation and the successful survey stays visible rather than collapsing into a single story.
