...
对于基础扎实、目标冲击顶尖院校的理科尖子,有机部分的难点在合成路线和推断题的综合运用。这类同学应当多做高综合度的真题,锻炼跨知识点串联的能力,把每一条经典转化序列玩到滚瓜烂熟。有志于参加[强基计划指南](/2023/05/21/gaokao-strong-foundation-plan/)所涉及的拔尖选拔的同学,更要在思维的灵活性上下功夫。
