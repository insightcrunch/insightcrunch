---
layout: post
title: "Infosys Resignation Process: Complete Step-by-Step Guide"
page_title: "Infosys Resignation Process: Notice Period, Handover, Exit Interview, Full and Final Settlement, and Everything You Need to Know Before Leaving"
date: 2021-05-18
categories: ["Industry"]
tags: ["Infosys Resignation", "Infosys Notice Period", "Infosys Resignation Process", "Infosys Exit Process", "Infosys Full and Final Settlement", "Infosys Relieving Letter", "Infosys Resignation Letter", "Infosys Exit Interview"]
excerpt: "Complete step-by-step guide to resigning from Infosys: how to submit resignation, notice period rules, buyout options, handover process, exit interview, FnF settlement timeline, and how to leave without burning bridges."
...
![Infosys Resignation Process Complete Guide](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
1. [Before You Resign: The Checklist](#before-you-resign-the-checklist)
2. [The Resignation Decision: Timing and Sequencing](#the-resignation-decision-timing-and-sequencing)
3. [How to Submit Your Resignation at Infosys](#how-to-submit-your-resignation-at-infosys)
4. [The Notice Period: Rules, Duration, and Options](#the-notice-period-rules-duration-and-options)
5. [Notice Period Buyout: How It Works](#notice-period-buyout-how-it-works)
6. [The Counter-Offer: How to Handle It](#the-counter-offer-how-to-handle-it)
7. [The Handover Process: Doing It Right](#the-handover-process-doing-it-right)
8. [The Exit Interview: What It Is and How to Handle It](#the-exit-interview-what-it-is-and-how-to-handle-it)
9. [Full and Final Settlement: What It Includes and How to Verify It](#full-and-final-settlement-what-it-includes-and-how-to-verify-it)
10. [The Relieving Letter and Experience Letter](#the-relieving-letter-and-experience-letter)
11. [PF Transfer or Withdrawal After Leaving](#pf-transfer-or-withdrawal-after-leaving)
12. [Gratuity on Resignation](#gratuity-on-resignation)
13. [Background Verification After Leaving Infosys](#background-verification-after-leaving-infosys)
14. [How to Leave Without Burning Bridges](#how-to-leave-without-burning-bridges)
...
What not to say in the manager conversation:
Do not criticize the team, the project, or Infosys in this conversation.
Do not reveal the new employer by name unless you are comfortable with that information being known within Infosys.
Do not give a lengthy explanation of why you are leaving. "I have received an opportunity I want to pursue" is sufficient.
Do not say you are leaving for salary reasons in a way that opens a negotiation if you have already decided. If you are open to a counter-offer, that conversation can happen after the initial resignation communication.
...
Reason for leaving (from a dropdown: better opportunity, higher education, personal reasons, relocation, etc.)
Last working day preference (which is your resignation date plus the notice period)
Any specific comments (optional; keep this professional and brief if used)
...
Example: an employee with a monthly gross salary of Rs. 50,000 wants to leave 30 days early (30 days of the 90-day notice period remaining after early release was denied):
Buyout = (50,000 / 30) × 30 = Rs. 50,000
...
All code should be:
Fully committed and pushed to the repository (no local-only work remaining).
Accompanied by comments for any complex logic that is not self-explanatory.
Tested against all known use cases before handover.
Documented in the README or technical wiki with clear setup instructions.
...
Standard exit interview questions at Infosys include:
What is your primary reason for leaving?
What did you enjoy most about working here?
What could Infosys have done to retain you?
How was your relationship with your manager and team?
How would you rate the work environment, the compensation, and the career growth opportunity?
Would you consider returning to Infosys in the future?
Would you recommend Infosys as an employer to others?
...
Employment dates (joining date, last working date): verified against Infosys's HR records.
Designation at joining and departure: verified against Infosys's HR records.
Reason for leaving: in voluntary checks, Infosys typically confirms "resigned" without further details.
Compensation: the previous CTC, verified against the salary declared to the new employer. Infosys confirms whether the declared CTC matches their records.
...
Provide the full notice period (or an agreed buyout) rather than abandoning the process.
Complete a thorough handover that makes the transition smooth for the team.
Maintain full productivity and professionalism through the entire notice period, not just the first few weeks.
Leave the office on the last day with all outstanding items resolved: code committed, documentation complete, accesses transferred, company property returned.
Send a brief goodbye email to the team that is professional and appreciative rather than valedictory or veiled with criticism.
Stay connected with meaningful professional relationships through LinkedIn rather than letting them go cold.
...
**8. If I resign during the [Mysore training](https://insightcrunch.com/2021/07/21/infosys-mysore-training/) period, what happens?**
...
Option 1: Request early release from Infosys and negotiate a later joining date with the new employer.
Option 2: Have the new employer cover the notice period buyout and pay Infosys directly.
Option 3: Pay the notice period buyout personally and join early.
Option 4: Request a combination: partial early release (Infosys agrees to release 30 days early) with a partial buyout for the remaining 30 days.
...
Morning: Manager conversation (in person or call).
Same day: Formal resignation submitted through HRMS.
Same day: Written resignation letter emailed to manager and HR (optional but recommended).
Confirm: system acknowledgment received and LWD confirmed in the portal.
...
Days 91-120: FnF processing. Follow up with HR on timeline if not received within 45 days.
Days 120-150 (typical): FnF credited to salary account. Relieving letter and experience letter issued through HRMS.
Days 130+: Initiate PF transfer to new employer's account.
Days 150+: If documents not received by now, escalate through Sparsh.
...
Do not mention the new employer by name unless asked.
Do not explain why you are leaving in detail.
Do not include grievances or criticisms.
Do not use a template with excessive flattery that does not reflect genuine sentiment.
Do adapt the specific language to your actual relationship with the manager and your actual tenure experience.
...
FnF settlement queries and discrepancy resolution.
Relieving letter and experience letter status and delay escalation.
Exit clearance sign-off tracking.
Variable pay status during the resignation period.
PF account update and exit date queries.
Notice period and buyout documentation.
Any HR process issues that arise during the exit.
...
1. **Have the new offer letter signed before resigning.** Never resign on a verbal offer.

2. **Calculate the notice period vs joining date before submitting.** The math must work before the resignation is official.

3. **Inform the manager directly before the HRMS submission.** The system notification is not the right way for the manager to find out.

4. **The notice period is 90 days for most employees.** Verify the specific period in your appointment letter.

5. **Buyout is available if needed.** The new employer can pay the buyout; it should be in the offer letter.

6. **Counter-offers are common and usually should be declined.** The reason for leaving usually does not change with more money.

7. **The handover is the professional legacy.** A complete handover preserves the relationship and the reference.

8. **The exit interview should be honest and constructive, not cathartic.** Venting in the exit interview creates complications without changing anything.

9. **FnF arrives in 45-60 days.** Verify every component when it comes.

10. **Relieving letter and experience letter come after FnF and exit clearance.** Start the clearance process early, not on the last day.

11. **Transfer the PF, do not withdraw.** Premature withdrawal is taxable and destroys long-term compounding.

12. **The professional relationships from Infosys have 30-year career value.** Leave in a way that preserves them.
...
The [Infosys Work Culture](https://insightcrunch.com/2021/11/18/infosys-work-culture-onsite-exit/) and Exit guide (Article 8) covers the workplace culture context that shapes the resignation experience and provides additional perspective on the exit process.

The [Infosys PF Withdrawal](https://insightcrunch.com/2021/05/26/infosys-pf-withdrawal-gratuity/) and Gratuity guide (Article 20) provides the complete PF management guide for the post-resignation period, including the transfer process, the withdrawal option, and the EPS scheme certificate.

The [Infosys Salary Structure](https://insightcrunch.com/2021/12/20/infosys-salary-structure/) guide (Article 2) covers the FnF component calculations in the context of the overall Infosys compensation structure.

The [Infosys Lateral Hiring](https://insightcrunch.com/2021/07/05/infosys-lateral-hiring-guide/) guide (Article 23) covers the negotiation for the new role that typically precedes the resignation: offer letter terms, notice period buyout coverage, and how to negotiate the transition effectively.
