---
layout: post
title: "Infosys for Non-IT Branches: Complete Guide"
page_title: "Infosys for Non-IT Branches: Eligibility, Preparation, Stream Allocation, Career Path, and Everything Mechanical, Civil, EEE, and ECE Students Need to Know"
date: 2021-11-10
categories: ["Industry"]
...
![Infosys for Non-IT Branches Guide](/assets/images/technology-industry-analysis-insightcrunch.webp)
...
1. [Who Qualifies as a Non-IT Branch at Infosys](#who-qualifies-as-a-non-it-branch-at-infosys)
2. [Eligibility Criteria for Non-IT Students](#eligibility-criteria-for-non-it-students)
3. [How the Selection Process Works for Non-IT Candidates](#how-the-selection-process-works-for-non-it-candidates)
4. [The Online Assessment: What Non-IT Students Need to Know](#the-online-assessment-what-non-it-students-need-to-know)
5. [Technical Interview Preparation for Non-IT Students](#technical-interview-preparation-for-non-it-students)
6. [HR Interview: Addressing the Non-IT Background](#hr-interview-addressing-the-non-it-background)
7. [[InfyTQ](https://insightcrunch.com/2021/10/09/infytq-preparation-guide/) and Pre-Joining Preparation](#infytq-and-pre-joining-preparation)
8. [Mysore Training: The Non-IT Student Experience](#mysore-training-the-non-it-student-experience)
9. [Stream Allocation for Non-IT Students](#stream-allocation-for-non-it-students)
10. [Common Myths About Non-IT Students at Infosys](#common-myths-about-non-it-students-at-infosys)
11. [Leveraging Your Engineering Domain in IT](#leveraging-your-engineering-domain-in-it)
12. [Career Trajectory: Non-IT Branch at Infosys](#career-trajectory-non-it-branch-at-infosys)
13. [Non-IT to Product Company: The Longer Route](#non-it-to-product-company-the-longer-route)
14. [Branch-Specific Guidance](#branch-specific-guidance)
...
Mechanical Engineering (B.E./B.Tech)
Civil Engineering (B.E./B.Tech)
Electrical Engineering (B.E./B.Tech)
Electrical and Electronics Engineering - EEE (B.E./B.Tech)
Electronics and Communication Engineering - ECE (B.E./B.Tech)
Electronics and Instrumentation Engineering (B.E./B.Tech)
Chemical Engineering (B.E./B.Tech)
Aerospace Engineering (B.E./B.Tech)
Production Engineering (B.E./B.Tech)
Industrial Engineering (B.E./B.Tech)
Biotechnology Engineering (B.E./B.Tech, some campus drives)
Agricultural Engineering (B.E./B.Tech, selected drives)
...
B.Sc. (Computer Science, Mathematics, Statistics, Physics) at some campuses
M.Sc. (Computer Science, Mathematics, Statistics) through specific channels
MCA (Master of Computer Applications) - treated similarly to IT branches in many cases
...
10th standard (Secondary School Certificate or equivalent)
12th standard (Higher Secondary Certificate or equivalent)
All semesters or years of the undergraduate engineering degree
...
The [Infosys selection process](https://insightcrunch.com/2021/12/28/infosys-hiring-process/) for non-IT students follows the same structure as for IT/CS students: online assessment, technical interview, and HR interview. The difference is not in the process structure but in what is tested in the technical interview and what the interviewer looks for.
...
The minimum technical knowledge expected for a non-IT student in the [Infosys technical interview](https://insightcrunch.com/2021/08/22/infosys-technical-interview-questions/):
...
Work through the pseudocode examples in the [Infosys Aptitude Questions](https://insightcrunch.com/2021/09/07/infosys-aptitude-questions-answers/) guide in this series. Each example includes a trace-through explanation that builds the understanding needed for the actual assessment. Five to ten hours of dedicated pseudocode practice is sufficient for most non-IT students to reach a comfortable level on this section.
...
Reality: All SE-level hires receive the same compensation package regardless of branch. A Mechanical Engineer joining as SE earns the same 3.6 LPA as a CS student joining as SE in the same batch. Designation-level parity is complete. The [DSE and PP](https://insightcrunch.com/2021/10/25/infosys-power-programmer-dse/) premium tracks are available to non-IT students through the same channels (DSE through the normal SE drive with stream performance, PP through [HackWithInfy](https://insightcrunch.com/2021/10/01/hackwithinfy-preparation/) which is open to all branches).
...
At the SE level (joining): 3.6 LPA (standardized, branch-agnostic).
At SSE (2-3 years): 5-7 LPA depending on performance, project, and appraisal outcomes.
At TA (4-6 years): 8-12 LPA.
At TL (6-9 years): 13-18 LPA.
...
The period between receiving the [Infosys offer letter](https://insightcrunch.com/2021/08/06/infosys-offer-letter-iconect-joining/) and the Mysore joining date is the highest-leverage preparation window available to non-IT students. How this period is used largely determines how the Mysore training experience unfolds.
...
**Q: You are from Mechanical Engineering. What programming have you done?**
Strong answer template: Be specific. Name the exact language(s), the context (course vs self-study vs project), the specific things you built, and what you have done since receiving the Infosys offer. Avoid saying "basic programming" without specifics.
...
**Q: What is a database and how is it different from a spreadsheet?**
...
**Q: Explain what your final year project does technically.**
Non-negotiable: be able to explain this in two minutes. Name the software tools used, describe the technical process, and state your specific contribution. Generic answers ("I worked on a renewable energy project") are unacceptable. Specific answers ("I built a MATLAB simulation of wind turbine output versus wind speed using the Betz limit as the theoretical maximum, and validated the simulation against published field data from three turbine sites") demonstrate genuine engagement.

**Q: Why are you interested in software development if your degree is in [branch]?**
This question requires a genuine answer. The answer must reference a specific experience that created the interest (not a vague preference), the specific aspect of software work that appeals, and the concrete steps taken since that experience to develop toward it.
...
**Q: Can you tell me what happens when you run a Python script?**
...
1. Python Fundamentals + Certification (most important)
2. DBMS Certification
3. Java Basics
4. Data Structures Awareness
...
This three-year certification path builds both the internal [Infosys appraisal](https://insightcrunch.com/2021/06/27/infosys-performance-appraisal/) record and the external market profile simultaneously.
