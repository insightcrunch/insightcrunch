...
EC1 consists of programmimg language where only error finding , output of prg are to be asked in test.Dont go for programmimg ....do smart study only and go for the only ppt which were given by TCS , it is more than enough.   
